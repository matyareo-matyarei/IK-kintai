...
# drive_dir.create_subfolder('サブフォルダ')

# スプレッドシートをコピーして指定したディレクトリに保存(移動)
## コピー元のスプレッドシートを取得
# sheets = session.spreadsheet_by_key('1iEssSEHR0FygCHRW0G22h9JOpo5eggewnkpFLyAjLF4')
sheets = session.file_by_url('https://docs.google.com/spreadsheets/d/1FN3ZSIeLHFxPYMUa-XaqHj8JIP9DhTbkXP9_RiiRijQ/edit')
...
## ()ファイルを先程指定したフォルダ（drive_dir）に移動
drive_dir.add(sheets)
